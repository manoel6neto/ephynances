...
class AgreementsController < ApplicationController
  ...
  private
    ...
    def agreement_params
      params.require(:agreement).permit(:type, :contactEmail, :contactPhone, :totalPrice, :contractorAgreementNumber, :physisAgreementNumber, :expiryDate, :status, :cnpjAmount)
    end
end
