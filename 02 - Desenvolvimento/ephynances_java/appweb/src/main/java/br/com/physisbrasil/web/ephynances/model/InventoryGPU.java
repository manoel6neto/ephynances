 ...
 * @author Thomas
 */
@Table(name = "ephynances_inventory_gpu")
@Entity
public class InventoryGPU implements BaseModel {
    ...
    public boolean equals(Object object) {        
        if (!(object instanceof InventoryGPU)) {
            return false;
        }
        InventoryGPU other = (InventoryGPU) object;
