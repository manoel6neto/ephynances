 ...
 * @author Thomas
 */
@Table(name = "ephynances_inventory_motherboard_history")
@Entity
public class InventoryMotherboardHistory implements BaseModel {
    ...
    public boolean equals(Object object) {        
        if (!(object instanceof InventoryMotherboardHistory)) {
            return false;
        }
        InventoryMotherboardHistory other = (InventoryMotherboardHistory) object;
