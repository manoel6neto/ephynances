...
-- Users --
insert into `user`(email, name, password, cpf, phone, cell_phone, max_sales_amount, profile_rule, delete_date, is_verified) 
values ('admin@physisbrasil.com.br', 'Administrador', 'c0859afbb1427c8ead10835ae456db9', '840.935.875-15', '(73) 9119-2425', '(73) 9119-2425', 0, 'Administrador', null, 0);
